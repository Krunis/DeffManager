...
// 	protoc        (unknown)
// source: packages/grpcapi/api.proto
...
func (TaskStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_packages_grpcapi_api_proto_enumTypes[0].Descriptor()
}

func (TaskStatus) Type() protoreflect.EnumType {
	return &file_packages_grpcapi_api_proto_enumTypes[0]
}
...
func (TaskStatus) EnumDescriptor() ([]byte, []int) {
	return file_packages_grpcapi_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *TaskRequest) Reset() {
	*x = TaskRequest{}
	mi := &file_packages_grpcapi_api_proto_msgTypes[0]
...
func (x *TaskResponse) Reset() {
	*x = TaskResponse{}
	mi := &file_packages_grpcapi_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TaskResponse) Descriptor() ([]byte, []int) {
	return file_packages_grpcapi_api_proto_rawDescGZIP(), []int{1}
}
...
var File_packages_grpcapi_api_proto protoreflect.FileDescriptor

const file_packages_grpcapi_api_proto_rawDesc = "" +
	"\n" +
	"\x1apackages/grpcapi/api.proto\x12\agrpcapi\"@\n" +
...
var (
	file_packages_grpcapi_api_proto_rawDescOnce sync.Once
	file_packages_grpcapi_api_proto_rawDescData []byte
)

func file_packages_grpcapi_api_proto_rawDescGZIP() []byte {
	file_packages_grpcapi_api_proto_rawDescOnce.Do(func() {
		file_packages_grpcapi_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_packages_grpcapi_api_proto_rawDesc), len(file_packages_grpcapi_api_proto_rawDesc)))
	})
	return file_packages_grpcapi_api_proto_rawDescData
}
...
func init() { file_packages_grpcapi_api_proto_init() }
func file_packages_grpcapi_api_proto_init() {
	if File_packages_grpcapi_api_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_packages_grpcapi_api_proto_goTypes,
		DependencyIndexes: file_packages_grpcapi_api_proto_depIdxs,
		EnumInfos:         file_packages_grpcapi_api_proto_enumTypes,
		MessageInfos:      file_packages_grpcapi_api_proto_msgTypes,
	}.Build()
	File_packages_grpcapi_api_proto = out.File
	file_packages_grpcapi_api_proto_goTypes = nil
	file_packages_grpcapi_api_proto_depIdxs = nil
}
